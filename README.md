...
Mermaid Diagram for full pipeline:
...
<svg width="800" height="1000" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Title -->
  <text x="400" y="25" text-anchor="middle" font-family="Arial, sans-serif" font-size="18" font-weight="bold" fill="#333">OpenFold3 Snakemake Workflow DAG</text>
  
  <!-- Input files (wildcards) -->
  <rect x="340" y="50" width="120" height="44" rx="8" fill="#E1F5EE" stroke="#0F6E56" stroke-width="2"/>
  <text x="400" y="68" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#0F6E56">{sample}.fasta</text>
  <text x="400" y="84" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#0F6E56">Input trigger</text>

  <!-- Rule: validate_input -->
  <rect x="320" y="130" width="160" height="56" rx="8" fill="#EEEDFE" stroke="#534AB7" stroke-width="2"/>
  <text x="400" y="150" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#534AB7">validate_input</text>
  <text x="400" y="166" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#534AB7">Parse and validate</text>
  <text x="400" y="180" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#534AB7">FASTA sequences</text>

  <!-- Rule: generate_msa -->
  <rect x="60" y="220" width="160" height="56" rx="8" fill="#FAECE7" stroke="#993C1D" stroke-width="2"/>
  <text x="140" y="240" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#993C1D">generate_msa</text>
  <text x="140" y="256" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#993C1D">ColabFold MSA</text>
  <text x="140" y="270" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#993C1D">search</text>

  <!-- Rule: openfold3_predict -->
  <rect x="320" y="220" width="160" height="56" rx="8" fill="#FAEEDA" stroke="#854F0B" stroke-width="2"/>
  <text x="400" y="240" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#854F0B">openfold3_predict</text>
  <text x="400" y="256" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#854F0B">GPU structure</text>
  <text x="400" y="270" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#854F0B">prediction</text>

  <!-- Rule: assess_quality -->
  <rect x="580" y="220" width="160" height="56" rx="8" fill="#FBEAF0" stroke="#993556" stroke-width="2"/>
  <text x="660" y="240" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#993556">assess_quality</text>
  <text x="660" y="256" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#993556">pLDDT and QC</text>
  <text x="660" y="270" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#993556">metrics</text>

  <!-- Rule: extract_ha1 -->
  <rect x="60" y="310" width="160" height="56" rx="8" fill="#E6F1FB" stroke="#185FA5" stroke-width="2"/>
  <text x="140" y="330" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#185FA5">extract_ha1</text>
  <text x="140" y="346" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#185FA5">HA1 domain from</text>
  <text x="140" y="360" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#185FA5">chain A</text>

  <!-- Rule: generate_report -->
  <rect x="320" y="310" width="160" height="56" rx="8" fill="#EAF3DE" stroke="#3B6D11" stroke-width="2"/>
  <text x="400" y="330" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#3B6D11">generate_report</text>
  <text x="400" y="346" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#3B6D11">Quarto HTML</text>
  <text x="400" y="360" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#3B6D11">report</text>

  <!-- Rule: archive_results -->
  <rect x="580" y="310" width="160" height="56" rx="8" fill="#E1F5EE" stroke="#0F6E56" stroke-width="2"/>
  <text x="660" y="330" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#0F6E56">archive_results</text>
  <text x="660" y="346" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#0F6E56">Store PDB and</text>
  <text x="660" y="360" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#0F6E56">metadata</text>

  <!-- Target rule: all -->
  <rect x="320" y="400" width="160" height="56" rx="8" fill="#F1EFE8" stroke="#5F5E5A" stroke-width="2"/>
  <text x="400" y="420" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#5F5E5A">all</text>
  <text x="400" y="436" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#5F5E5A">Final pipeline</text>
  <text x="400" y="450" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#5F5E5A">targets</text>

  <!-- Rule dependency arrows -->
  <!-- Input to validate_input -->
  <line x1="400" y1="94" x2="400" y2="128" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>

  <!-- validate_input to parallel rules -->
  <path d="M360 186 L180 218" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <line x1="400" y1="186" x2="400" y2="218" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <path d="M440 186 L620 218" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>

  <!-- Parallel rules to downstream rules -->
  <path d="M140 276 L140 308" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <path d="M400 276 L400 308" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <path d="M640 276 L640 308" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>

  <!-- Cross dependencies (dashed) -->
  <path d="M220 248 L320 338" fill="none" stroke="#666" stroke-width="1" stroke-dasharray="4,4" marker-end="url(#arrow)"/>
  <path d="M480 248 L420 308" fill="none" stroke="#666" stroke-width="1" stroke-dasharray="4,4" marker-end="url(#arrow)"/>
  <path d="M580 248 L480 338" fill="none" stroke="#666" stroke-width="1" stroke-dasharray="4,4" marker-end="url(#arrow)"/>

  <!-- All rules to all target -->
  <path d="M180 366 L360 398" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <path d="M400 366 L400 398" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <path d="M620 366 L440 398" fill="none" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>

  <!-- File outputs -->
  <rect x="80" y="490" width="140" height="32" rx="6" fill="#f5f5f5" stroke="#999" stroke-width="1"/>
  <text x="150" y="509" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#333">validated_input.fasta</text>

  <rect x="240" y="490" width="100" height="32" rx="6" fill="#f5f5f5" stroke="#999" stroke-width="1"/>
  <text x="290" y="509" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#333">msa/</text>

  <rect x="360" y="490" width="140" height="32" rx="6" fill="#f5f5f5" stroke="#999" stroke-width="1"/>
  <text x="430" y="509" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#333">predicted_structure.pdb</text>

  <rect x="520" y="490" width="120" height="32" rx="6" fill="#f5f5f5" stroke="#999" stroke-width="1"/>
  <text x="580" y="509" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#333">quality_report.json</text>

  <!-- Final outputs -->
  <rect x="60" y="560" width="120" height="32" rx="6" fill="#e8f5e8" stroke="#4a9" stroke-width="1"/>
  <text x="120" y="579" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#4a9">report.html</text>

  <rect x="200" y="560" width="120" height="32" rx="6" fill="#e8f5e8" stroke="#4a9" stroke-width="1"/>
  <text x="260" y="579" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#4a9">full.pdb</text>

  <rect x="340" y="560" width="120" height="32" rx="6" fill="#e8f5e8" stroke="#4a9" stroke-width="1"/>
  <text x="400" y="579" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#4a9">HA1.pdb</text>

  <rect x="480" y="560" width="120" height="32" rx="6" fill="#e8f5e8" stroke="#4a9" stroke-width="1"/>
  <text x="540" y="579" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#4a9">metadata.json</text>

  <!-- Resource annotations -->
  <rect x="50" y="620" width="250" height="36" rx="6" fill="#e6f3ff" stroke="#0066cc" stroke-width="1"/>
  <text x="175" y="635" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#0066cc">Resource requirements</text>
  <text x="175" y="650" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#0066cc">GPU: 1, Mem: 32GB, Cores: 60</text>

  <rect x="320" y="620" width="250" height="36" rx="6" fill="#fff8e1" stroke="#ff9900" stroke-width="1"/>
  <text x="445" y="635" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#ff9900">Logging integration</text>
  <text x="445" y="650" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#ff9900">JSON logs → NiFi → HDFS</text>

  <!-- Legend -->
  <text x="50" y="700" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#333">Rule types</text>
  
  <rect x="50" y="720" width="16" height="12" rx="2" fill="#E1F5EE" stroke="#0F6E56"/>
  <text x="74" y="730" font-family="Arial, sans-serif" font-size="12" fill="#333">Input/Output</text>
  
  <rect x="160" y="720" width="16" height="12" rx="2" fill="#EEEDFE" stroke="#534AB7"/>
  <text x="184" y="730" font-family="Arial, sans-serif" font-size="12" fill="#333">Validation</text>
  
  <rect x="250" y="720" width="16" height="12" rx="2" fill="#FAECE7" stroke="#993C1D"/>
  <text x="274" y="730" font-family="Arial, sans-serif" font-size="12" fill="#333">External tools</text>
  
  <rect x="360" y="720" width="16" height="12" rx="2" fill="#FAEEDA" stroke="#854F0B"/>
  <text x="384" y="730" font-family="Arial, sans-serif" font-size="12" fill="#333">GPU compute</text>
  
  <rect x="480" y="720" width="16" height="12" rx="2" fill="#FBEAF0" stroke="#993556"/>
  <text x="504" y="730" font-family="Arial, sans-serif" font-size="12" fill="#333">Analysis</text>
  
  <rect x="50" y="750" width="16" height="12" rx="2" fill="#E6F1FB" stroke="#185FA5"/>
  <text x="74" y="760" font-family="Arial, sans-serif" font-size="12" fill="#333">Processing</text>
  
  <rect x="160" y="750" width="16" height="12" rx="2" fill="#EAF3DE" stroke="#3B6D11"/>
  <text x="184" y="760" font-family="Arial, sans-serif" font-size="12" fill="#333">Reporting</text>
  
  <rect x="250" y="750" width="16" height="12" rx="2" fill="#F1EFE8" stroke="#5F5E5A"/>
  <text x="274" y="760" font-family="Arial, sans-serif" font-size="12" fill="#333">Targets</text>
  
  <line x1="360" y1="755" x2="380" y2="755" stroke="#333" stroke-width="2" marker-end="url(#arrow)"/>
  <text x="390" y="760" font-family="Arial, sans-serif" font-size="12" fill="#333">Direct dependency</text>
  
  <line x1="530" y1="755" x2="550" y2="755" stroke="#666" stroke-width="1" stroke-dasharray="4,4" marker-end="url(#arrow)"/>
  <text x="560" y="760" font-family="Arial, sans-serif" font-size="12" fill="#333">Cross dependency</text>

  <!-- Wildcard explanation -->
  <text x="50" y="800" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#333">Snakemake wildcards</text>
  <text x="50" y="820" font-family="Arial, sans-serif" font-size="12" fill="#333">{sample} = H1N1_strain_A, H3N2_strain_B, etc.</text>
  <text x="50" y="840" font-family="Arial, sans-serif" font-size="12" fill="#333">Rules expand for each sample automatically</text>
  <text x="50" y="860" font-family="Arial, sans-serif" font-size="12" fill="#333">Example: H1N1_strain_A.fasta → archive/H1N1_strain_A/H1N1_strain_A_full.pdb</text>
